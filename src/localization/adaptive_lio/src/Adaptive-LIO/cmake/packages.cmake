...
## NOTE: removed legacy catkin find_package to use ament_cmake (ROS2) from root CMakeLists.
## If you need ROS1 compatibility, restore a catkin-specific CMake flow separately.
...
if(livox_ros_driver_FOUND)
  add_definitions(-DLIVOX_ROS1_DRIVER)
endif()

# livox_ros_driver2
find_package(livox_ros_driver2 QUIET)
if(livox_ros_driver2_FOUND)
  add_definitions(-DLIVOX_ROS2_DRIVER)
endif()
